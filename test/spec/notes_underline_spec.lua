...
describe("notes underline", function()
  ...
  describe("U6: sign color matches audit color", function()
    it("red highlight gets AuditorNoteSignRed sign", function()
      local bufnr = setup_buf({ "hello world" }, 1, 0)
    ...
    it("blue highlight gets AuditorNoteSignBlue sign", function()
      local bufnr = setup_buf({ "hello world" }, 1, 0)
  ...
  describe("U13: same-line notes with different colors", function()
    it("each underline's sign matches its word's color", function()
      local bufnr = setup_buf({ "hello world" }, 1, 0)
      ...
      assert.equals("AuditorNoteSignRed", marks[1][4].sign_hl_group)
      assert.equals("AuditorNoteSignBlue", marks[2][4].sign_hl_group)
      cleanup(bufnr)
    end)
  end)
